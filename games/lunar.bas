...
360 LET T = 10
370 LET A1 = M - N
380 IF A1 < 0.001 THEN 500
390 IF T < 0.001 THEN 290
400 LET S = T
410 LET A1 = N + S * K
420 IF M >= A1 THEN 440
430 LET S = (M - N) / K
440 GOSUB 900
450 IF I <= 0 THEN 760
460 IF V <= 0 THEN 480
