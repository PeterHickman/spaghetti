...
1280 IF BE < 0 THEN 1490
1290 IF BA < 0 THEN 1410
1300 IF BB < 0 THEN 1430
1310 IF BC < 0 THEN 1450
1320 IF BD < 0 THEN 1470
1330 IF BF < 0 THEN 1510
1340 IF BG < 0 THEN 1530
1350 IF BH < 0 THEN 1550
1360 IF BI < 0 THEN 1570
1370 PRINT
...
1610 IF (BA = BB) AND (BB = BC) THEN 1870
1620 IF (BD = BE) AND (BE = BF) THEN 1870
1630 IF (BG = BH) AND (BH = BI) THEN 1870
1640 IF (BA = BD) AND (BD = BG) THEN 1870
1650 IF (BB = BE) AND (BE = BH) THEN 1870
1660 IF (BC = BF) AND (BF = BI) THEN 1870
1670 IF (BA = BE) AND (BE = BI) THEN 1870
1680 IF (BC = BE) AND (BE = BG) THEN 1870
