...
335 INPUT "YOUR PHOTON BOMB? " A1
350 INPUT "HOW FAR OUT DO YOU WISH TO DETONATE IT? " D1
365 PRINT
366 PRINT
370 LET A = A + R
...
510 PRINT "DO YOU WISH TO TRY TO DESTROY IT (1=YES 0=NO)? " ANS
530 IF ANS = 1 GOTO 270
540 PRINT "GOOD BYE."
999 END
