...
220 LET A = RND(13) + 2
230 IF A < 2 GOTO 220
240 IF A > 14 GOTO 220
250 LET B = RND(13) + 2
260 IF B < 2 GOTO 250
270 IF B > 14 GOTO 250
280 IF A >= B GOTO 220
290 IF A < 11 GOTO 340
300 IF A = 11 GOTO 360
310 IF A = 12 GOTO 380
320 IF A = 13 GOTO 400
330 IF A = 14 GOTO 420
340 PRINT A
350 GOTO 430
360 PRINT "JACK"
370 GOTO 430
...
410 GOTO 430
420 PRINT "ACE"
430 IF B < 11 GOTO 480
440 IF B = 11 GOTO 500
450 IF B = 12 GOTO 520
460 IF B = 13 GOTO 540
470 IF B = 14 GOTO 560
480 PRINT B
490 GOTO 580
500 PRINT "JACK"
510 GOTO 580
...
680 LET C = RND(13) + 2
690 IF C < 2 GOTO 680
700 IF C > 14 GOTO 680
710 IF C < 11 GOTO 760
720 IF C = 11 GOTO 780
730 IF C = 12 GOTO 800
740 IF C = 13 GOTO 820
750 IF C = 14 GOTO 840
760 PRINT C
770 GOTO 860
780 PRINT "JACK"
790 GOTO 860
