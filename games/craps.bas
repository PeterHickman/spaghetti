...
80 LET T = 1
90 PRINT "PICK A NUMBER AND INPUT TO ROLL DICE";
100 INPUT Z
110 LET X = RND(0)
120 LET T = T + 1
130 IF T <= Z THEN 110
140 PRINT "INPUT THE AMOUNT OF YOUR WAGER." ;
150 INPUT F
...
190 LET X = E + S
200 IF X = 7 THEN 340
210 IF X = 11 THEN 340
220 IF X = 1 THEN 170
230 IF X = 2 THEN 370
240 IF X = 0 THEN 170
250 IF X = 2 THEN 410
260 IF X = 3 THEN 410
270 IF X = 12 THEN 410
280 IF X = 5 THEN 460
290 IF X = 6 THEN 460
300 IF X = 8 THEN 460
310 IF X = 9 THEN 460
320 IF X = 10 THEN 460
330 IF X = 4 THEN 460
...
630 GOTO 440
640 PRINT " IF YOU WANT TO PLAY AGAIN PRINT 5 IF NOT PRINT 2";
650 INPUT M
660 IF R < 0 THEN 690
670 IF R > 0 THEN 710
680 IF R = 0 THEN 730
